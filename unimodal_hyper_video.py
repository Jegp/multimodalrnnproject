...
def model(X_train, y_train, X_test, y_test, max_features, maxlen):
    ...
    model.add(LSTM({{choice([200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 330, 340, 350, 360, 370, 380, 390])}}, 
              input_shape = (1, max_features), 
              return_sequences = True))

    #model.add(LSTM({{choice([700, 750, 800, 850, 900, 950])}},
    #      return_sequences = True))

    model.add(LSTM({{choice([60, 70, 80, 90, 100, 110, 120, 130, 140])}},
